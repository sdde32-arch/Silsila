              ...
              <div className="grid grid-cols-5 gap-1">
                {lessonData.steps.map((step, idx) => (
                  <button
                    ...
                    title={`Step ${idx + 1} of 6 for Ayah ${activeAyahNumber}: ${step.title}`}
                  />
                ))}
              </div>
              <div className="flex items-center justify-between text-[10.5px]">
                <div className="flex items-center gap-1.5 truncate">
                  <span className="font-black text-amber-950 bg-amber-200/90 border border-amber-300 px-1.5 py-0.5 rounded text-[10px] shrink-0">
                    Step {currentStepIdx + 1}/6 for Ayah {activeAyahNumber}
                  </span>
            ...
            {currentStepIdx < totalSteps - 1 ? (
              ...
              >
                <span>
                  ...
                  {currentStepIdx === 2 && 'Next: Fill-in-the-Blank Recall (Step 4/6) →'}
                  {currentStepIdx === 3 && 'Next: Blur & Self-Recite (Step 5/6) →'}
                  {currentStepIdx === 4 && 'Next: Full Blind Scoring (Step 6/6) →'}
                </span>
